...
App::App(float windowX, float windowY, const char *title)
...
void App::draw() {
    ...
    if (timeToInit) {
        vao.reset(new lix::VAO{lix::Attributes{lix::VEC3, lix::VEC3},
                               {
                                   0.0f,
                                   1.0f,
                                   0.0f,
    ...
    static lix::ShaderProgram shaderProgram{LIX_SHADER_VERSION R"(
...
void main()
{
    ...
    static lix::ShaderProgram textureShader{LIX_SHADER_VERSION R"(
layout(location=0) in vec3 aPos;
...
void main()
{
    ...
    static std::shared_ptr<lix::Texture> texture =
        lix::Texture::Basic(lix::Color::red);
    ...
    static lix::ShaderProgram objectShader{assets::shaders::object_vert,
                                           LIX_SHADER_VERSION R"(
precision highp float;
...
void main()
{
    ...
    static lix::UniformBuffer cameraUBO{sizeof(CameraBlock), &cameraBlock,
                                        "CameraBlock", 0};
