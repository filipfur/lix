...
namespace lix
{
    ...
    public:
		...
		ShaderProgram* setUniform(const std::string& name, const glm::ivec2& vector);
		ShaderProgram* setUniform(const std::string& name, const glm::vec3& vector);
		ShaderProgram* setUniform(const std::string& name, const glm::ivec3& vector);
		...
		ShaderProgram* setUniform(const std::string& name, const std::vector<glm::vec3>& vectors);
