...
template <typename Container> struct infinite_iterator {
    ...
    friend bool operator==(const infinite_iterator &a,
                           const infinite_iterator &b) {
...
template <typename Container> struct const_infinite_iterator {
    ...
    friend bool operator==(const const_infinite_iterator &a,
                           const const_infinite_iterator &b) {
        return a.m_it == b.m_it;
    }
