...
struct CharacterController {
    CharacterController(std::shared_ptr<lix::DynamicBody> dynamicBody_)
        : dynamicBody{dynamicBody_} {}
    ...
    bool onGround() { return platform != nullptr; }
    ...
    void rotate(float r) { yaw += r; }

    void stopJump() { deltaControl.y = 0.0f; }
    ...
    enum class MovementState { IDLE, FORWARD, LEFT, RIGHT, JUMPING, FALLING };
