...
bool lix::pointInTriangle2d(const glm::vec3 &p, const glm::vec3 &a,
...
bool lix::pointInTriangle(const glm::vec3 &p, const glm::vec3 &a,
                          const glm::vec3 &b, const glm::vec3 &c) {
...
bool lix::containsVertex(const std::vector<glm::vec3> &s, const glm::vec3 &v) {
    auto it =
        std::find_if(std::begin(s), std::end(s),
                     [&v](const glm::vec3 &p1) { return isSameVertex(v, p1); });
    return it != s.end();
}
...
lix::extremePoints(const std::vector<glm::vec3> &s) {
...
std::vector<glm::vec3> lix::minimumBoundingBox(const glm::vec3 &min,
                                               const glm::vec3 &max) {
    return lix::cube_corner_points(min, max);
}

std::pair<int, float> lix::indexAlongDirection(const std::vector<glm::vec3> &s,
                                               const glm::vec3 &D) {
    int index{-1};
...
bool lix::isAdjacent(const unsigned int *a, const unsigned int *b,
                     lix::Edge &edge) {
