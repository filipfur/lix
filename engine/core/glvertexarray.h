...
class VertexArray : Element {
  public:
    ...
    VertexArray(const Attributes &attributes,
                ...
                const std::vector<GLuint> &indices, GLenum mode = GL_TRIANGLES,
    ...
    VertexArray(const Attributes &attributes,
                ...
                const std::vector<GLuint> &indices, GLenum mode = GL_TRIANGLES,
                GLenum usage = GL_STATIC_DRAW);
    VertexArray(const Attributes &attributes, void *vertices_data,
                GLuint vertices_size, GLuint *indices_data, GLuint indices_size,
                GLenum mode = GL_TRIANGLES, GLenum usage = GL_STATIC_DRAW);
    VertexArray(const Attributes &attributes, void *vertices_data,
                GLuint vertices_size, GLushort *indices_data,
                GLuint indices_size, GLenum mode = GL_TRIANGLES,
                GLenum usage = GL_STATIC_DRAW);
    ...
    std::shared_ptr<VBO> createVbo(GLenum usage,
                                   ...
                                   int attribDivisor = 0);
    std::shared_ptr<EBO> createEbo(GLenum usage, GLuint indices_size,
                                   GLuint *indices_data);
    std::shared_ptr<EBO> createEbo(GLenum usage, GLuint indices_size,
                                   GLushort *indices_data);
    std::shared_ptr<EBO> createEbo(GLenum usage,
