...
lix::Texture::Texture(unsigned int width, unsigned int height, GLenum type,
    ...
    : _width{width}, _height{height}, _type{type},
      _internalFormat{internalFormat}, _colorFormat{colorFormat} {
    glGenTextures(1, &_id);
...
lix::Texture::Texture(unsigned char *bytes, unsigned int width,
                      unsigned int height, GLenum type, GLenum internalFormat,
                      GLenum colorFormat)
...
lix::Texture::Texture(const unsigned char *bytes, unsigned int width,
                      unsigned int height, GLenum type, GLenum internalFormat,
                      GLenum colorFormat)
    : Texture{width, height, type, internalFormat, colorFormat} {
    bind(_active);
...
lix::Texture::~Texture() noexcept { glDeleteTextures(1, &_id); }
...
std::shared_ptr<lix::Texture> lix::Texture::Basic(lix::Color color) {
    ...
    return std::make_shared<lix::Texture>(data, 1, 1, GL_UNSIGNED_BYTE, GL_RGB8,
                                          GL_RGB);
}
...
lix::Texture *lix::Texture::setFilter(GLenum filter) {
...
lix::Texture *lix::Texture::setWrap(GLenum wrap) {
...
lix::Texture *lix::Texture::bind() { return bind(_active); }
...
int lix::Texture::width() const { return _width; }

int lix::Texture::height() const { return _height; }

GLenum lix::Texture::type() const { return _type; }

GLenum lix::Texture::internalFormat() const { return _internalFormat; }

GLenum lix::Texture::colorFormat() const { return _colorFormat; }
