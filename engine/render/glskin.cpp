...
std::map<std::string, std::shared_ptr<lix::SkinAnimation>>::iterator lix::Skin::currentAnimation()
{
    return _currentAnimation;
}

void lix::Skin::setCurrentAnimation(std::map<std::string, std::shared_ptr<lix::SkinAnimation>>::iterator currentAnimation)
{
